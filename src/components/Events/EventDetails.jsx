...
export default function EventDetails() {
  ...
  const {mutate, isPending: isPendingDeletion, error: deleteError,isError:isErrorDeleting } = useMutation({
  ...
  if (isError){
    content = (
      <div id='event-details-content' className='center'>
        <ErrorBlock title="Could not fetch an event data!" message={error.info?.message || 'Failed to fetch event data, please try again later.'}/>
      </div>
    )
  }
  if (data){
